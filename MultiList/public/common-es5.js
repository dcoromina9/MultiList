  ...
  function srcAppServicesMovieServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var MovieService = /*#__PURE__*/function () {
      function MovieService(http) {
        ...
        this.http = http;
        this.url = '';
        this.apiKey = '6c277a80';
      }

      _createClass(MovieService, [{
        key: "searchMovies",
        value: function searchMovies(title, type) {
          this.url = "https://www.omdbapi.com/?s=".concat(encodeURI(title), "&type=").concat(type, "&apikey=").concat(this.apiKey);
        ...
        value: function getDetails(id) {
          return this.http.get("https://www.omdbapi.com/?i=".concat(id, "&plot=full&apikey=").concat(this.apiKey));
        }
      }]);
    ...
    MovieService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])], MovieService);
    /***/
  }
}]);
